(function iftMapFunction(){
        ...
        Geomap = function() {
            ...
            return _createClass(f, [
            {
                ...
                value: function(f) {
                    ...
                    //THIS IS WHERE THE CLICK EVENT HANDLERS LIVE

                    stateClickEventHandler(event);
    ...
    function stateClickEventHandler(event){
        var activeStateItem = document.querySelector('.activeState');

        if(activeStateItem !== null){
            activeStateItem.classList.remove('activeState');
            event.target.classList.add('activeState');
        }
        else {
            event.target.classList.add('activeState');
        }
